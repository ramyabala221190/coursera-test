...
resolve:{pop:['$stateParams','restservice',function($stateParams,restservice)
{


return restservice.sub($stateParams.itemId,$stateParams.first,$stateParams.last,$stateParams.email,$stateParams.phone);
